...
const ReadMore = ({ userId, data }) => {
    ...
    const handleUpdate = async (updatedInfo) => {
        try {
            ...
            Swal.fire('Error!', 'There was an issue updating your recipe.', 'error');
        }
    };
        ...
        <section className='h-fit'>
                <div key={recipes.id} className="relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-12 xl:max-w-6xl">
                    <div className="w-full h-64 lg:w-1/2 lg:h-auto">
                        <img className="h-full w-full object-cover" src={recipes.preview} alt={recipes.recipeName} />
                    </div>
                    <div className="max-w-lg bg-white md:max-w-2xl md:z-10 md:shadow-lg md:absolute md:top-0 md:mt-48 lg:w-3/5 lg:left-0 lg:mt-20 lg:ml-20 xl:mt-24 xl:ml-12">
                        ...
                        <div className="flex flex-col p-12 md:px-16">
                            ...
                            <p className="mt-4">{recipes.ingredients}</p>
                            <p className="mt-4">{recipes.instructions}</p>
